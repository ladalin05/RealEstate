...
import { showProperty } from '../../services/functionService';
...
const PropertyDetails = () => {
    ...
    const {gallery_images, latest_list, property, related_list } = propertyData
    ...
    useEffect(() => {
        showProperty(property.id, navigate);
    });
                        ...
                        <div className="col-xl-8 col-lg-12 ">
                            ...
                            <div className="listing-desc-wrap mt-4">
                                <div className="list-details-wrap">
                                    ...
                                    {/* AMENITIES */}
                                    {property.amenities.split(',').length > 0 && (
                                        <div className="list-details-section">
